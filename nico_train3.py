...
def get_args():
    ...
    parser.add_argument("--learning_rate", "-l", type=float, default=.0001, help="Learning rate")
...
class Trainer:
    def __init__(self, args, device):
        ...
        self.extractor.load_state_dict(torch.load("./ckpt1/best_cartoon_stage2"))
    ...
    def do_training(self):
        ...
        for self.current_epoch in range(self.args.epochs):
            ...
            if val_acc > current_high:
                ...
                torch.save(self.extractor.state_dict(), os.path.join('ckpt1/', 'best_' + self.args.target[0] + '_stage3'))
    ...
    def warm_up(self, epoch, now_loss=None, prev_loss=None, decay_rate=0.85):
