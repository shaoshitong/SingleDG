...
class Trainer:
    def __init__(self, args, device):
        ...
        self.extractor.load_state_dict(torch.load("./ckpt1/best_sketch_stage2"))
        self.teacher = resnet18(classes=args.n_classes).to(device)
        self.teacher.load_state_dict(torch.load("./ckpt1/best_sketch_stage3"))
        self.teacher.eval()
    ...
    def do_training(self):
        ...
        for self.current_epoch in range(self.args.epochs):
            ...
            if val_acc > current_high:
                ...
                torch.save(self.extractor.state_dict(), os.path.join('ckpt1/', 'best_' + self.args.target[0] + '_stage4'))
